...
urlpatterns = [
    ...
    path("me/teams/", views.MyTeamsView.as_view(), name="user_my_teams"),
    path("me/active-team/", views.switch_active_team, name="user_switch_active_team"),
    path("me/invites/accept/", views.accept_invite_existing_user, name="user_accept_invite"),

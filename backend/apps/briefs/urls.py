...
urlpatterns = [
    ...
    path("billing/", views.billing, name="brief_billing"),
    path("billing/share/", views.toggle_billing_share, name="brief_billing_toggle_share"),
    path("billing/shared/<uuid:share_token>/", views.public_billing_report, name="brief_billing_public"),

 ...
 *
 * Manages its own mutation via useShareProject — the parent only needs to
 * pass the project object and an onClose callback.
 *
 * Props:
 *   cf      — project object (needs cf.id, cf.share_enabled, cf.share_token)
